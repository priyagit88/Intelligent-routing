...
def main():
    ...
    run_scenario("Q-Learning", RLRouting, agent=agent, packets=15, training=True)
    
    # Test
    agent.epsilon = 0.05
    pdr, lat = run_scenario("Q-Learning", RLRouting, agent=agent, packets=5, training=False)
    ...
    run_scenario("DQN", DQNRouting, agent=dqn_agent, packets=15, training=True)
    
    # Test
    dqn_agent.epsilon = 0.05
    pdr, lat = run_scenario("DQN", DQNRouting, agent=dqn_agent, packets=5, training=False)
